...
export default function MainPage() {
  return (
    <section className=" px-[50px] mb-[80px] m:mb-[120px] l:mb-[100px]">
      <div className='absolute top-[15px] left-[15px] l:top-[25px] l:left-[25px] '>
      ...
      <Image
        ...
        alt="people run"
      />
      <h1 className='min-w-[300px] mt-[200px] mb-[10px] text-3xl font-bold leading-9 text-white l:mb-[35px] l:mt-[400px]'>
        Дивіться ТБ та кіно без реклами в єдиній передплаті
      </h1>
      <p class="opacity-80 min-w-[288px] text-base leading-tight text-white mb-[168px] m:mb-[330px] l:text-lg l:mb-[600px] ">
